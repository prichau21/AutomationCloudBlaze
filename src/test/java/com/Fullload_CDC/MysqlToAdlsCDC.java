...
public class MysqlToAdlsCDC extends ReuseFuntions implements IOnBoarding , IMonitoring
{
...
{    
   ...
   public static void verifyAddDataFlow() throws InterruptedException, AWTException 
     ...
     test = report.startTest("Verify Add DataFlow for MYSQl to adls Full load");
		 ...
		 Thread.sleep(3000);
         driver.findElement(By.xpath(xpathmysqltoAdls)).click();
         Thread.sleep(3000);
		 driver.findElement(By.id("name")).sendKeys(reader.getCellData("DataFlow","Name", 12));
		 Thread.sleep(3000);
	
		 driver.findElement(By.id("description")).sendKeys(reader.getCellData("DataFlow", "Description", 12));
		 Thread.sleep(2000);
		
		 driver.findElement(By.className("css-1hwfws3")).click();
		 Thread.sleep(4000);
		 driver.findElement(By.xpath("/html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","Name", 12)+"']")).click();
		 Thread.sleep(2500);
		
		 driver.findElement(By.xpath(xpathAdlsDest)).click();
		 Thread.sleep(1500);
		 driver.findElement(By.xpath("//html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","NameD", 12)+"']")).click();
		 Thread.sleep(1000);
         ...
         driver.findElement(By.xpath("(/html/body/div//table/tbody/tr//td[2][text()='"+reader.getCellData("DataFlow","Tablename",12)+"'])[2]/preceding-sibling::td")).click();// to select store table
         Thread.sleep(1000);

		 driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='"+reader.getCellData("DataFlow","Tablename",12)+"'])[2]/following-sibling::td)[1]//span")).click();// to on CDC option 
		 Thread.sleep(1000);
		 driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='"+reader.getCellData("DataFlow","Tablename",12)+"'])[2]/following-sibling::td)[2]//span")).click();//on track delete Record
		 Thread.sleep(1000);
         driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='"+reader.getCellData("DataFlow","Tablename",12)+"'])[2]/following-sibling::td)[3]//span")).click();//on Do Cleansing
         Thread.sleep(1000);
         driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='"+reader.getCellData("DataFlow","Tablename",12)+"'])[2]/following-sibling::td)[4]//span")).click();//click on Schema Propogated
		 Thread.sleep(3000);
        // driver.findElement(By.xpath("/html/body/div[6]/div[2]/div[1]/div[4]/div/div[1]/div[1]/table/tbody/tr[10]/td[2]/button")).click(); // to click on [|] sign to see columns
         driver.findElement(By.xpath("(/html/body/div//table/tbody/tr//td[2][text()='"+reader.getCellData("DataFlow","Tablename",12)+"'])[2]/child::button")).click();  // to click on [|] sign to see columns
		 Thread.sleep(2000);
          
         driver.findElement(By.name("11")).click();// select Incremental Column 
         Thread.sleep(3000);
    	  ...
    	  String connectionUrl =
 	        ...
 	        try (Connection connection = DriverManager.getConnection(connectionUrl);
 	         Statement statement = connection.createStatement();) {
 	            ...
 	            String selectSql = "update [Scheduling].[DataflowExeuctionCalendar] set currentsnapshotdate='2006-02-18'  where DataflowId=1819";
...
@Test(priority = 6,dependsOnMethods = { "verifyDataFlowOnMontioringScreen" },groups = { "Smoke" })
   public static void verifyDeleteScheduledFlow() throws InterruptedException  
    ...
    Thread.sleep(1000);
      driver.findElement(By.xpath("//*[@id='root']//div/table/tbody/tr[1]/td[2][text()='"+reader.getCellData("DataFlow","Name", 12)+"']/..//a[2]")).click();
      Thread.sleep(1000);
			...
			String connectionUrl =
			 ...
			 try (Connection connection = DriverManager.getConnection(connectionUrl);
		   	         Statement statement = connection.createStatement();) {
		   	            ...
		   	            String selectSql = "update [Scheduling].[DataflowExeuctionCalendar] set currentsnapshotdate='2006-02-19'  where DataflowId=1819";//NEED TO ADD DATAFLOW ID AND DATE
		   	             statement.executeQuery(selectSql);
