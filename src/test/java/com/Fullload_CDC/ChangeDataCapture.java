...
import com.relevantcodes.extentreports.LogStatus;
 ...
 public class ChangeDataCapture extends ReuseFuntions implements IOnBoarding ,IMonitoring
 {
	    	...
	    	verifyDestinationADLS(8);
	               ...
	               public static void verifyAddDataFlow() throws InterruptedException 
	                 {    
						 ...
						 Thread.sleep(2500);
						 driver.findElement(By.xpath("/html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","Name", 8)+"']")).click();
						 Thread.sleep(2500);
						
						 driver.findElement(By.xpath(xpathAdlsDest)).click();						
						 Thread.sleep(1500);
						 driver.findElement(By.xpath("//html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","NameD", 8)+"']")).click();
						 Thread.sleep(1000);
						 ...
						 driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='superstoresales'])[2]/following-sibling::td)[1]//span")).click();// to on CDC option 
						 Thread.sleep(1000);
						 driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='superstoresales'])[2]/following-sibling::td)[2]//span")).click();//on track delete Record
						 Thread.sleep(1000);
                         driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='superstoresales'])[2]/following-sibling::td)[3]//span")).click();//on Do Cleansing
                         Thread.sleep(1000);
                         driver.findElement(By.xpath("((/html/body/div//table/tbody/tr//td[2][text()='superstoresales'])[2]/following-sibling::td)[4]//span")).click();//click on Schema Propogated
						 Thread.sleep(3000);
