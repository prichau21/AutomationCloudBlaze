...
public class MySqlToAdls extends ReuseFuntions implements IOnBoarding , IMonitoring{
    ...
    {	 verifyDestinationADLS(11);
        ...
        public static void verifyAddDataFlow() throws InterruptedException, AWTException 
          ...
          test = report.startTest("Verify Add DataFlow for MYSQl to adls Full load");
             ...
             Thread.sleep(2500);
			 driver.findElement(By.id("name")).sendKeys(reader.getCellData("DataFlow","Name", 11));
  		     Thread.sleep(2500);
			 ...
			 Thread.sleep(4000);
			 driver.findElement(By.xpath("/html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","Name", 11)+"']")).click();
			 Thread.sleep(2500);
			
			 driver.findElement(By.xpath(xpathAdlsDest)).click();
			 Thread.sleep(1500);
			 driver.findElement(By.xpath("//html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","NameD", 11)+"']")).click();
			 Thread.sleep(1000);
