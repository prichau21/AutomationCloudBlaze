...
public class OracleToAdlsDM extends ReuseFuntions implements IOnBoarding ,IMonitoring
{     @Test(priority=1, groups = { "Smoke" })
	  public static void verifySourceAdd() throws InterruptedException 
	  {    
	       
			     
	      	verifySourceOracle(16);
...
public static void verifyAddDataFlow() throws InterruptedException, AWTException 
  ...
  test = report.startTest("Verify Add DataFlow");
	 ...
	 Thread.sleep(3000);
     driver.findElement(By.xpath(xpathOracletoadlsDM)).click();
  Thread.sleep(2500);
	 driver.findElement(By.id("name")).sendKeys(reader.getCellData("DataFlow","Name", 16));
	 Thread.sleep(2500);
	 ...
	 Thread.sleep(4000);
	 driver.findElement(By.xpath("/html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","Name", 16)+"']")).click();
	 Thread.sleep(2500);
	
	 driver.findElement(By.xpath(xpathAdlsDest)).click();
	 Thread.sleep(1500);
	 driver.findElement(By.xpath("//html/body/div//form//div[text()='"+reader.getCellData("Storage&Service","NameD", 16)+"']")).click();
	 Thread.sleep(1000);
